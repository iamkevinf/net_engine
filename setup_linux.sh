...
g++ -c NetEngine/Src/cell.cpp -o build/net_msg_task.o
...
g++ -std=c++11 -pthread NetEngine/EasyTcpServer/server.cpp -o bin/server -I NetEngine/Src build/tcp_server.o build/client_socket.o build/net_time.o build/cell.o build/net_msg_task.o
