...
g++ -g -std=c++11 -pthread NetEngine/EasyTcpServer/server.cpp -o bin/server -I NetEngine/Src build/my_server.o build/tcp_server.o build/client_socket.o build/net_time.o build/cell.o build/cell_task.o build/semaphore.o
