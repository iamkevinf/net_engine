...
g++ -g -D_DEBUG -std=c++11 -pthread NetEngine/EasyTcpServer/server.cpp -o bin/server -I NetEngine/Src build/my_server.o build/tcp_server.o build/client_socket.o build/net_time.o build/cell.o build/cell_task.o build/semaphore.o build/cell_thread.o build/cell_log.o build/cell_network.o
g++ -g -std=c++11 -pthread NetEngine/EasyTcpClient/client.cpp -o bin/client -I NetEngine/Src build/tcp_client.o build/net_time.o  build/cell_log.o
